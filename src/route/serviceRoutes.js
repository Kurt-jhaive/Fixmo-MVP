...
import { uploadServiceImage, processServiceImage } from '../middleware/multer.js';
import {
    getProviderServices,
    getServiceById,
    createService,
...
router.post('/services', uploadServiceImage.single('service_picture'), processServiceImage, createService);
