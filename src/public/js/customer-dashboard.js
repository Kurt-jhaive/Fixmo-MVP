...
class CustomerDashboard {
    ...
    renderBookingCardHorizontal(booking) {
        const canCall = booking.actions ? booking.actions.canCall : 
            (['accepted', 'approved', 'confirmed', 'on the way', 'in progress'].includes(booking.appointment_status));
        const canCancel = booking.actions ? booking.actions.canCancel : 
            (['pending', 'accepted', 'approved', 'confirmed'].includes(booking.appointment_status));
