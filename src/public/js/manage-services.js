...
class ManageServices {
                ...
                <div class="service-body">
                    ...
                    <div class="service-details">
                        <div class="service-price">
                            ...
                            ${parseFloat(service.price_per_hour).toLocaleString()}/hr
                        </div>
                        <div class="service-duration">
                            <i class="fas fa-clock"></i>
                            ${service.estimated_duration}h duration
                        </div>
                    </div>
    ...
    async handleAddService() {
        ...
        if (!serviceData.service_name || !serviceData.service_description) {
    ...
    showEditServiceModal(serviceId) {
        ...
        document.getElementById('edit_price_per_hour').value = service.price_per_hour;
        document.getElementById('edit_estimated_duration').value = service.estimated_duration;
